...
const socialLinkClassName =
  "inline-flex h-11 w-11 shrink-0 items-center justify-center rounded-sm bg-gray-700 text-white transition-colors duration-300 hover:bg-yellow-500 hover:text-gray-950 focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[var(--accent)]";

export default function Footer() {
  return (
    <footer className="site-footer relative z-10 shrink-0 px-4 py-6 text-center text-[var(--text-secondary)]">
      <nav aria-label="Social links" className="mb-3 flex items-center justify-center gap-4">
        <Link
          href="https://github.com/Wyden13"
          id="github"
        ...
        <Link
          href="https://www.linkedin.com/in/uyen-nguyen-00509a2b8"
          id="linkedin"
